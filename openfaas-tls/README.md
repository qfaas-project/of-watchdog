# QFaaS Note for openfaas-tls of-watchdog

OpenFaaS original of-watchdog using TLS connections
...
```shell script
./build.sh
docker tag openfaas/of-watchdog:latest-dev-x86_64 openfaas/of-watchdog-tls:latest-dev-x86_64
docker images
# You should find a docker image called openfaas/of-watchdog-tls:latest-dev-x86_64
